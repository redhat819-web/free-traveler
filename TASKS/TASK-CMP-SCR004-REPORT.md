# CMP-SCR004-REPORT — 신고 버튼/폼

- **Task ID:** `CMP-SCR004-REPORT`
- **제목:** 신고 버튼/폼
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 31번 행(`CMP-SCR004-REPORT`)을 상세화한 것이다.
...
- `src/components/mates/ReportForm.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 사유 코드+설명, 신고 ID 즉시 표시(3초 이내), Admin 신고 큐 OPEN/REVIEWING/RESOLVED/DISMISSED 상태 처리
