# CMP-SCR001-SHARE — 공유 버튼

- **Task ID:** `CMP-SCR001-SHARE`
- **제목:** 공유 버튼
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P2
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 12번 행(`CMP-SCR001-SHARE`)을 상세화한 것이다.
- Category: **COMPONENT** / 우선순위: **P2**
...
- `src/components/shared/ShareButton.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- Web Share API 시도 후 실패 시 URL 복사 폴백
...
- `MANUAL-CHECK-CLIENT-STATE` 시나리오로 검증한다.

## Verify

- MANUAL-CHECK-CLIENT-STATE
