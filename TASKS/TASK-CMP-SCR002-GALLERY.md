...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 18번 행(`CMP-SCR002-GALLERY`)을 상세화한 것이다.
...
- `src/components/about/PhotoGallery.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 서로 다른 장소 8장 이상, alt에 장소·상황 설명

## Visual AC

- Desktop 4×2/Mobile 1~2열, lazy load
- Lorem ipsum, '준비 중', '정보 확인 필요' 문구 및 내용 없는 Card를 두지 않는다(D-001/DESIGN.md 공통 규칙).

## Security/Privacy AC

- 이미지 로드 실패 시 alt 유지 대체 플레이스홀더
