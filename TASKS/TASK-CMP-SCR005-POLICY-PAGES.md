# CMP-SCR005-POLICY-PAGES — 정책 페이지(약관/개인정보/안전수칙/면책)

- **Task ID:** `CMP-SCR005-POLICY-PAGES`
- **제목:** 정책 페이지(약관/개인정보/안전수칙/면책)
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 37번 행(`CMP-SCR005-POLICY-PAGES`)을 상세화한 것이다.
...
- `src/components/account/PolicyPages.tsx`
- `src/data/policies.ts` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 이용약관·개인정보 처리방침·동행 안전수칙·콘텐츠 면책 안내, 정책 버전 기록
...
- 동행 작성 시 동의 시각 저장(§3.3 CMP-SCR003-MATE-COMPOSE와 연동)
