...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 40번 행(`DATA-REPRESENTATIVE`)을 상세화한 것이다.
...
- `src/data/representative.ts` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 대표명·수치·소개문·철학·타임라인·방문국가·갤러리·추천 여행지
