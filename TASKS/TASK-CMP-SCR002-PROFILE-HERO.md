# CMP-SCR002-PROFILE-HERO — 대표 Hero

- **Task ID:** `CMP-SCR002-PROFILE-HERO`
- **제목:** 대표 Hero
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 13번 행(`CMP-SCR002-PROFILE-HERO`)을 상세화한 것이다.
...
- `src/components/about/ProfileHero.tsx` (create)
