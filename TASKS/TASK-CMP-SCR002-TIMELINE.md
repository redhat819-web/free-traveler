# CMP-SCR002-TIMELINE — 여행 타임라인

- **Task ID:** `CMP-SCR002-TIMELINE`
- **제목:** 여행 타임라인
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 16번 행(`CMP-SCR002-TIMELINE`)을 상세화한 것이다.
...
- `src/components/about/TravelTimeline.tsx` (create)
