# CMP-SCR001-RECENT-MATES — 최근 동행 이야기 미리보기

- **Task ID:** `CMP-SCR001-RECENT-MATES`
- **제목:** 최근 동행 이야기 미리보기
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 10번 행(`CMP-SCR001-RECENT-MATES`)을 상세화한 것이다.
- Category: **COMPONENT** / 우선순위: **P1**
- 선행 Task(DB-ACCESS)가 먼저 완료되어야 이 Task를 시작할 수 있다.
...
- `src/components/home/RecentMatesPreview.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 모집중 동행글 3개 미리보기 또는 완성형 Empty State

## Visual AC

- Card 3개 또는 안내+이용방법+CTA 3요소
