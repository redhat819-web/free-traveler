# CMP-SCR005-MY-ACTIVITY — 내 활동(내 글/참가요청/차단 관리)

- **Task ID:** `CMP-SCR005-MY-ACTIVITY`
- **제목:** 내 활동(내 글/참가요청/차단 관리)
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P0
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 35번 행(`CMP-SCR005-MY-ACTIVITY`)을 상세화한 것이다.
...
- `src/components/account/MyActivity.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 내 글 수정/마감/삭제, 참가 요청 승인/거절, 차단 목록·해제

## Visual AC

- 목록 없음 시 완성형 Empty State("아직 작성한 동행 글이 없습니다"+이용 방법+CTA)
- Lorem ipsum, '준비 중', '정보 확인 필요' 문구 및 내용 없는 Card를 두지 않는다(D-001/DESIGN.md 공통 규칙).

## Security/Privacy AC

- 승인 요청자 있을 시 중요 일정 변경 전 경고
