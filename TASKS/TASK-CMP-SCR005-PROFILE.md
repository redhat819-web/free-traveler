# CMP-SCR005-PROFILE — Member 프로필

- **Task ID:** `CMP-SCR005-PROFILE`
- **제목:** Member 프로필
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 34번 행(`CMP-SCR005-PROFILE`)을 상세화한 것이다.
...
- `src/components/account/ProfileForm.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 닉네임·연령대·여행 스타일 필수, 성별 선택
