# CMP-SCR002-STATS — 여행 지표 카드

- **Task ID:** `CMP-SCR002-STATS`
- **제목:** 여행 지표 카드
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 14번 행(`CMP-SCR002-STATS`)을 상세화한 것이다.
...
- `src/components/about/TravelStats.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- `50+ Trips`, `30+ Countries` 좌우 2분할 + 1줄 설명
