...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 11번 행(`CMP-SCR001-FAVORITES`)을 상세화한 것이다.
...
- `src/components/home/FavoriteButton.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- `localStorage` 추가/해제/조회, 중복 방지
