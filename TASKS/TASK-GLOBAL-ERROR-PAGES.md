# GLOBAL-ERROR-PAGES — 404/500/권한없음/외부연결실패

- **Task ID:** `GLOBAL-ERROR-PAGES`
- **제목:** 404/500/권한없음/외부연결실패
- **Category:** GLOBAL
- **Type:** global
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 50번 행(`GLOBAL-ERROR-PAGES`)을 상세화한 것이다.
- Category: **GLOBAL** / 우선순위: **P1**
- 선행 Task(GLOBAL-NAV-FOOTER)가 먼저 완료되어야 이 Task를 시작할 수 있다.
