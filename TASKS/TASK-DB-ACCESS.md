...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 44번 행(`DB-ACCESS`)을 상세화한 것이다.
- Category: **DB** / 우선순위: **P0**
...
- mates/applications/blocks/reports/profiles/outbound_url_settings CRUD 서버 액션
...
- CSRF/SameSite 쿠키, 입력 검증·이스케이프로 저장 XSS 차단
