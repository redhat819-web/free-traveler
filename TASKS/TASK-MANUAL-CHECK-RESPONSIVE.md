# MANUAL-CHECK-RESPONSIVE — 반응형 수동 확인

- **Task ID:** `MANUAL-CHECK-RESPONSIVE`
- **제목:** 반응형 수동 확인
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 63번 행(`MANUAL-CHECK-RESPONSIVE`)을 상세화한 것이다.
- Category: **MANUAL_CHECK** / 우선순위: **P2**
- 선행 Task(GLOBAL-RESPONSIVE)가 먼저 완료되어야 이 Task를 시작할 수 있다.
...
- 320px~1440px 뷰포트 리사이즈로 가로 스크롤·겹침·SCR-001/003 Mobile 변형 레이아웃 확인
