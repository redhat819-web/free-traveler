# GLOBAL-TOAST — Toast/상태 배지 알림 시스템

- **Task ID:** `GLOBAL-TOAST`
- **제목:** Toast/상태 배지 알림 시스템
- **Category:** GLOBAL
- **Type:** global
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 52번 행(`GLOBAL-TOAST`)을 상세화한 것이다.
...
- `src/components/shared/Toast.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 참가요청/승인/거절/신고 처리 결과를 인앱 Toast로 안내(이메일 미발송)
