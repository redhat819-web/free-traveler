# GLOBAL-NAV-FOOTER — 전역 내비게이션/Footer

- **Task ID:** `GLOBAL-NAV-FOOTER`
- **제목:** 전역 내비게이션/Footer
- **Category:** GLOBAL
- **Type:** global
- **Priority:** P0
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 46번 행(`GLOBAL-NAV-FOOTER`)을 상세화한 것이다.
...
- 5개 Screen 공통 Header(워드마크/내비/계정)·Footer(3열/1열)
