# CMP-SCR002-MEMORABLE-CTA — 기억에 남는 여행지 + CTA

- **Task ID:** `CMP-SCR002-MEMORABLE-CTA`
- **제목:** 기억에 남는 여행지 + CTA
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 19번 행(`CMP-SCR002-MEMORABLE-CTA`)을 상세화한 것이다.
...
- `src/components/about/MemorableDestinations.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 4개 Card + 문의/SNS 링크(빈 값 미표시, 허용 프로토콜만) + `/travel-tools`·`/mates` CTA 2개
