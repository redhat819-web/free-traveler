# CMP-SCR004-FILTER — 검색 Filter + 결과 요약

- **Task ID:** `CMP-SCR004-FILTER`
- **제목:** 검색 Filter + 결과 요약
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P0
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 27번 행(`CMP-SCR004-FILTER`)을 상세화한 것이다.
...
- `src/components/mates/MateFilterBar.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 국가·지역·기간 겹침·연령대·성별·스타일·모집상태 필터, "조건에 맞는 모집글 N건"

## Visual AC

- Chip/Form 혼합, 44×44px 터치 영역
