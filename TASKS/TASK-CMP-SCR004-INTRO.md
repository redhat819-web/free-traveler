# CMP-SCR004-INTRO — Intro(축소형 Hero)

- **Task ID:** `CMP-SCR004-INTRO`
- **제목:** Intro(축소형 Hero)
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 26번 행(`CMP-SCR004-INTRO`)을 상세화한 것이다.
...
- `src/components/mates/MatesIntro.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- "믿을 수 있는 동행을 찾아보세요" + "새 동행 글 작성하기" CTA
