# CMP-SCR002-COUNTRY-CHIPS — 방문 국가 Chip

- **Task ID:** `CMP-SCR002-COUNTRY-CHIPS`
- **제목:** 방문 국가 Chip
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P2
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 17번 행(`CMP-SCR002-COUNTRY-CHIPS`)을 상세화한 것이다.
...
- `src/components/about/VisitedCountryChips.tsx` (create)
