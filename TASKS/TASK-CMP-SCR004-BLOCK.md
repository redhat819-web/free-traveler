# CMP-SCR004-BLOCK — 차단 버튼

- **Task ID:** `CMP-SCR004-BLOCK`
- **제목:** 차단 버튼
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 32번 행(`CMP-SCR004-BLOCK`)을 상세화한 것이다.
...
- `src/components/mates/BlockButton.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- 사용자 차단, 차단 후 상호 글·프로필·요청 비노출
