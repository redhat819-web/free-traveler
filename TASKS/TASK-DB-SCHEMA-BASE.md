...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 42번 행(`DB-SCHEMA-BASE`)을 상세화한 것이다.
- Category: **DB** / 우선순위: **P0**
...
- 테이블 6개만 선언: `member_profiles`, `mates`, `mate_applications`, `mate_blocks`, `mate_reports`, `outbound_url_settings`
