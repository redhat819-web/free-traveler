# GLOBAL-SEO-META — SEO 메타데이터

- **Task ID:** `GLOBAL-SEO-META`
- **제목:** SEO 메타데이터
- **Category:** GLOBAL
- **Type:** global
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 48번 행(`GLOBAL-SEO-META`)을 상세화한 것이다.
...
- `src/app/**/layout.tsx` 또는 `metadata` export (modify)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- title/description/canonical/OG/구조화 데이터 5개 Route 전부
...
- `MANUAL-CHECK-PERF-SEO` 시나리오로 검증한다.

## Verify

- MANUAL-CHECK-PERF-SEO
