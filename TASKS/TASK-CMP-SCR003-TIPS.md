# CMP-SCR003-TIPS — 비전달 고지 + 찾기 Tip

- **Task ID:** `CMP-SCR003-TIPS`
- **제목:** 비전달 고지 + 찾기 Tip
- **Category:** COMPONENT
- **Type:** component
- **Priority:** P1
...
- 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 25번 행(`CMP-SCR003-TIPS`)을 상세화한 것이다.
...
- `src/components/travel-tools/SearchTips.tsx` (create)

> Expected Files 밖의 파일은 생성·수정하지 않는다.

## Functional AC

- "입력값은 외부 사이트로 전달되지 않습니다" 고지 + Tip 3개(가격 비교/날짜 유연화/왕복·편도)
